...
sys.path.append('/home/www/resistome.cnag.cat/httpdocs/erga-dev')
sys.path.append('/home/www/resistome.cnag.cat/erga-dev')
sys.path.append('/home/www/resistome.cnag.cat/erga-dev/erga')
