...
class SampleCollection(models.Model):
    ...
    team = models.ForeignKey(CollectionTeam, on_delete=models.SET_NULL, verbose_name="collection team", null=True, blank=True)
...
class Sample(models.Model):
    ...
    tolid = models.CharField(max_length=20, help_text='Registered ToLID for the Specimen', null=True, blank=True, verbose_name="ToLID")
    specimen_id = models.CharField(max_length=30, help_text='Internal Specimen ID', null=True, blank=True)
...
class Sequencing(models.Model):
    ...
    team = models.ForeignKey(SequencingTeam, on_delete=models.SET_NULL, verbose_name="sequencing team")
...
class Curation(models.Model):
    species = models.OneToOneField(TargetSpecies, on_delete=models.CASCADE, verbose_name="species")
    team = models.ForeignKey(CurationTeam, on_delete=models.SET_NULL, verbose_name="curation team")
...
class Annotation(models.Model):
    species = models.OneToOneField(TargetSpecies, on_delete=models.CASCADE, verbose_name="species")
    team = models.ForeignKey(AnnotationTeam, on_delete=models.SET_NULL, verbose_name="annotation team")
...
class Submission(models.Model):
    species = models.OneToOneField(TargetSpecies, on_delete=models.CASCADE, verbose_name="species")
    team = models.ForeignKey(SubmissionTeam, on_delete=models.SET_NULL, verbose_name="submission team")
...
class AssemblyProject(models.Model):
    species = models.OneToOneField(TargetSpecies, on_delete=models.CASCADE, verbose_name="species")
    team = models.ForeignKey(AssemblyTeam, on_delete=models.SET_NULL, verbose_name="assembly team")
...
class Assembly(models.Model):
    ...
    pipeline = models.ForeignKey(AssemblyPipeline, on_delete=models.SET_NULL, verbose_name="Assembly pipeline",null=True, blank=True )
    ...
    busco_db = models.ForeignKey(BUSCOdb, on_delete=models.SET_NULL, verbose_name="BUSCO db", null=True, blank=True)
    busco_version = models.ForeignKey(BUSCOversion, on_delete=models.SET_NULL, verbose_name="BUSCO version",null=True, blank=True)
