# Generated by Django 3.0.2 on 2023-01-30 19:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('lead', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='taxonomy_team_lead', to='status.Person')),
                ('members', models.ManyToManyField(to='status.Person')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_coordinator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='status.Person', verbose_name='sample_coordinator')),
        ...
        migrations.AddField(
            ...
            name='lead',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='extraction_team_lead', to='status.Person'),
        ),
        migrations.AddField(
            model_name='extractionteam',
            name='members',
        ...
        migrations.AddField(
            ...
            name='lead',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='community_annotation_team_lead', to='status.Person'),
        ),
        migrations.AddField(
            model_name='communityannotationteam',
            name='members',
        ...
        migrations.AddField(
            ...
            name='lead',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='barcoding_team_lead', to='status.Person'),
        ),
        migrations.AddField(
            model_name='barcodingteam',
            name='members',
